...
class TextMessage(BaseModel):
    ...
    body: str = Field(
        ...,
        max_length=4096,
        description="The text content of the message (max 4096 chars)"
    )
    preview_url: bool = Field(
        False,
        description="Enable URL preview for links in the message"
    )
...
class ImageMessage(BaseModel):
    ...
    id: Optional[str] = Field(
        None,
        description="Media ID from uploaded image"
    )
    link: Optional[str] = Field(
        None,
        description="URL of the image (HTTPS only)"
    )
    caption: Optional[str] = Field(
        None,
        max_length=1024,
        description="Optional caption for the image (max 1024 chars)"
    )
...
class DocumentMessage(BaseModel):
    ...
    id: Optional[str] = Field(
        None,
        description="Media ID from uploaded document"
    )
    link: Optional[str] = Field(
        None,
        description="URL of the document (HTTPS only)"
    )
    caption: Optional[str] = Field(
        None,
        max_length=1024,
        description="Optional caption for the document (max 1024 chars)"
    )
    filename: Optional[str] = Field(
        None,
        description="Filename to display (required when using link)"
    )
...
class AudioMessage(BaseModel):
    ...
    id: Optional[str] = Field(
        None,
        description="Media ID from uploaded audio"
    )
    link: Optional[str] = Field(
        None,
        description="URL of the audio file (HTTPS only)"
    )
...
class VideoMessage(BaseModel):
    ...
    link: Optional[str] = Field(
        None,
        description="URL of the video file (HTTPS only)"
    )
    caption: Optional[str] = Field(
        None,
        max_length=1024,
        description="Optional caption for the video (max 1024 chars)"
    )
...
class StickerMessage(BaseModel):
    ...
    id: Optional[str] = Field(
        None,
        description="Media ID from uploaded sticker"
    )
    link: Optional[str] = Field(
        None,
        description="URL of the sticker file (HTTPS only, WebP format)"
    )
...
class InteractiveBody(BaseModel):
    ...
    text: str = Field(
        ...,
        max_length=1024,
        description="Body text (max 1024 chars)"
    )
...
class Button(BaseModel):
    ...
    type: str = Field(
        "reply",
        description="Button type (reply)"
    )
    reply: Dict[str, str] = Field(
        ...,
        description="Reply button with 'id' and 'title'"
    )
...
class InteractiveAction(BaseModel):
    ...
    sections: Optional[List[Section]] = Field(
        None,
        max_length=10,
        description="List sections (max 10)"
    )
    name: Optional[str] = Field(
        None,
        description="Action name for CTA URL buttons"
    )
    parameters: Optional[Dict[str, str]] = Field(
        None,
        description="Parameters for CTA URL buttons"
    )
...
class InteractiveMessage(BaseModel):
    ...
    type: str = Field(
        ...,
        description="Interactive type: button, list, or cta_url"
    )
    ...
    action: InteractiveAction = Field(
        ...,
        description="Interactive action (required)"
    )
...
class TemplateParameter(BaseModel):
    ...
    image: Optional[Union[ImageMessage, Dict[str, str]]] = Field(
        None,
        description="Image for image parameters"
    )
    video: Optional[Union[VideoMessage, Dict[str, str]]] = Field(
        None,
        description="Video for video parameters"
    )
    document: Optional[Union[DocumentMessage, Dict[str, str]]] = Field(
        None,
        description="Document for document parameters"
    )
    currency: Optional[Dict[str, Any]] = Field(
        None,
        description="Currency object with fallback_value, code, amount_1000"
    )
    date_time: Optional[Dict[str, Any]] = Field(
        None,
        description="Date time object with fallback_value"
    )
...
class TemplateComponent(BaseModel):
    ...
    type: str = Field(
        ...,
        description="Component type: header, body, button"
    )
    sub_type: Optional[str] = Field(
        None,
        description="Button sub-type: quick_reply, url"
    )
...
class TemplateLanguage(BaseModel):
    ...
    policy: str = Field(
        "deterministic",
        description="Language policy: deterministic or fallback"
    )
...
class TemplateMessage(BaseModel):
    ...
    name: str = Field(
        ...,
        description="Template name (must be approved)"
    )
    language: TemplateLanguage = Field(
        ...,
        description="Template language settings"
    )
...
class ReactionMessage(BaseModel):
    ...
    emoji: str = Field(
        ...,
        description="Emoji to react with (or empty string to remove)"
    )
...
class MessageStatus(BaseModel):
    ...
    status: str = Field(
        ...,
        description="Status: sent, delivered, read, failed"
    )
    timestamp: str = Field(
        ...,
