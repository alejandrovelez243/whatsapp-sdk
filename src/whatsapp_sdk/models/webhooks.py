...
class WebhookVideoMessage(BaseModel):
    ...
    sha256: str = Field(
        ...,
        description="SHA256 hash of the video"
    )
    caption: Optional[str] = Field(
        None,
        description="Optional caption"
...
class WebhookAudioMessage(BaseModel):
    ...
    sha256: str = Field(
        ...,
        description="SHA256 hash of the audio"
    )
...
class WebhookStickerMessage(BaseModel):
    ...
    sha256: str = Field(
        ...,
        description="SHA256 hash of the sticker"
    )
...
class WebhookButtonReply(BaseModel):
    ...
    id: str = Field(
        ...,
        description="Button ID that was clicked"
    )
    title: str = Field(
        ...,
        description="Button title that was clicked"
    )
...
class WebhookListReply(BaseModel):
    ...
    id: str = Field(
        ...,
        description="Selected row ID"
    )
    title: str = Field(
        ...,
        description="Selected row title"
    )
...
class WebhookInteractiveMessage(BaseModel):
    ...
    type: str = Field(
        ...,
        description="Interactive type: button_reply or list_reply"
    )
    button_reply: Optional[WebhookButtonReply] = Field(
        None,
        description="Button reply data"
    )
    list_reply: Optional[WebhookListReply] = Field(
        None,
        description="List selection data"
    )
...
class WebhookMessage(BaseModel):
    ...
    context: Optional[WebhookContext] = Field(
        None,
        description="Context if this is a reply"
    )
    text: Optional[WebhookTextMessage] = Field(
        None,
        description="Text message data"
    )
    image: Optional[WebhookImageMessage] = Field(
        None,
        description="Image message data"
    )
    video: Optional[WebhookVideoMessage] = Field(
        None,
        description="Video message data"
    )
    audio: Optional[WebhookAudioMessage] = Field(
        None,
        description="Audio message data"
    )
    document: Optional[WebhookDocumentMessage] = Field(
        None,
        description="Document message data"
    )
    location: Optional[WebhookLocationMessage] = Field(
        None,
        description="Location message data"
    )
    sticker: Optional[WebhookStickerMessage] = Field(
        None,
        description="Sticker message data"
    )
    interactive: Optional[WebhookInteractiveMessage] = Field(
        None,
        description="Interactive message response data"
    )
    reaction: Optional[WebhookReactionMessage] = Field(
        None,
        description="Reaction message data"
    )
    contacts: Optional[List[Dict[str, Any]]] = Field(
        None,
        description="Contact cards shared"
    )
    errors: Optional[List[Dict[str, Any]]] = Field(
        None,
        description="Any errors associated with the message"
    )
...
class WebhookContact(BaseModel):
    ...
    profile: Optional[Dict[str, str]] = Field(
        None,
        description="Contact profile with name"
    )
    wa_id: str = Field(
        ...,
...
class WebhookValue(BaseModel):
    ...
    metadata: WebhookMetadata = Field(
        ...,
        description="Webhook metadata"
    )
    contacts: Optional[List[WebhookContact]] = Field(
        None,
        description="Contact information"
    )
    messages: Optional[List[WebhookMessage]] = Field(
        None,
        description="Incoming messages"
    )
    statuses: Optional[List[WebhookStatus]] = Field(
        None,
...
class WebhookChange(BaseModel):
    ...
    value: WebhookValue = Field(
        ...,
        description="Change value"
    )
    field: str = Field(
        ...,
        description="Field that changed (usually 'messages')"
    )
...
class WebhookEvent(BaseModel):
    ...
    object: str = Field(
        ...,
        description="Object type (usually 'whatsapp_business_account')"
    )
...
class WebhookVerification(BaseModel):
    ...
    hub_challenge: str = Field(
        ...,
        alias="hub.challenge",
        description="Challenge to echo back"
    )
    hub_verify_token: str = Field(
        ...,
        alias="hub.verify_token",
        description="Verify token to validate"
    )