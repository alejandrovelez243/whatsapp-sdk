...
class TemplateButton(BaseModel):
    ...
    type: str = Field(
        ...,
        description="Button type: QUICK_REPLY, URL, or PHONE_NUMBER"
    )
    text: str = Field(
        ...,
    ...
    url: Optional[str] = Field(
        None,
        description="URL for URL buttons (can include {{1}} placeholder)"
    )
    ...
    example: Optional[List[str]] = Field(
        None,
        description="Example values for URL placeholders"
    )
...
class TemplateHeaderExample(BaseModel):
    ...
    header_text: Optional[List[str]] = Field(
        None,
        description="Example text values for header placeholders"
    )
    header_handle: Optional[List[str]] = Field(
        None,
        description="Example media handles for media headers"
    )
...
class TemplateBodyExample(BaseModel):
    ...
    body_text: Optional[List[List[str]]] = Field(
        None,
        description="Example text values for body placeholders"
    )
...
class TemplateExample(BaseModel):
    ...
    header_handle: Optional[List[str]] = Field(
        None,
        description="Header media handle examples"
    )
...
class TemplateComponentDefinition(BaseModel):
    ...
    text: Optional[str] = Field(
        None,
        description="Component text with {{placeholders}}"
    )
    buttons: Optional[List[TemplateButton]] = Field(
        None,
        description="List of buttons for BUTTONS component"
    )
    example: Optional[TemplateExample] = Field(
        None,
...
class Template(BaseModel):
    ...
    status: Optional[str] = Field(
        None,
        description="Template status: APPROVED, PENDING, REJECTED"
    )
    ...
    quality_score: Optional[Dict[str, Any]] = Field(
        None,
        description="Template quality score information"
    )
...
class TemplateAnalytics(BaseModel):
    ...
    clicked: Optional[int] = Field(
        None,
        description="Number of button clicks (for templates with buttons)"
    )
