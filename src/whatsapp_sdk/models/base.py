...
class Contact(BaseModel):
    ...
    input: str = Field(
        ...,
        description="The phone number input originally provided"
    )
    wa_id: str = Field(
        ...,
        description="The WhatsApp ID of the contact (formatted phone number)"
    )
...
class Error(BaseModel):
    ...
    code: int = Field(
        ...,
        description="Error code from WhatsApp API"
    )
    ...
    error_user_title: Optional[str] = Field(
        None,
        description="User-friendly error title"
    )
    error_user_msg: Optional[str] = Field(
        None,
...
class MessageResponse(BaseResponse):
    ...
    contacts: List[Contact] = Field(
        ...
        description="List of contacts that were processed"
    )
    messages: List[Message] = Field(
        default_factory=list,
        description="List of messages that were sent"
    )
...
class PaginationInfo(BaseModel):
    ...
    cursors: Optional[PaginationCursor] = Field(
        None,
