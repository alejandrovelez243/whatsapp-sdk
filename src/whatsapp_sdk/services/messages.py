...
class MessagesService:
    ...
    def send_text(
        ...
        text: Optional[Union[str, TextMessage, Dict]] = None,
    ...
    def send_image(
        self,
        to: str,
        image: Union[str, ImageMessage, Dict],
    ...
    def send_document(
        self,
        to: str,
        document: Union[str, DocumentMessage, Dict],
        caption: Optional[str] = None,
    ...
    def send_audio(
        self,
        to: str,
        audio: Union[str, AudioMessage, Dict]
    ) -> MessageResponse:
    ...
    def send_video(
        self,
        to: str,
        video: Union[str, VideoMessage, Dict],
        caption: Optional[str] = None
    ) -> MessageResponse:
    ...
    def send_sticker(
        self,
        to: str,
        sticker: Union[str, StickerMessage, Dict]
    ) -> MessageResponse:
    ...
    def send_contact(
        self,
        to: str,
        contacts: Union[List[Contact], ContactMessage, Dict]
    ) -> MessageResponse:
    ...
    def send_interactive(
        self,
        to: str,
        interactive: Union[InteractiveMessage, Dict]
    ) -> MessageResponse:
